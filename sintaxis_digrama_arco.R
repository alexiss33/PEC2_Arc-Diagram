...
edges <- read.csv2("C:/MAESTRIA/SEGUNDO_SEMESTRE/VISUALIZACION DE DATOS/PEC2/diagrama_arco/GameofThrones-T1-Network-EDGES-CSV.csv")
nodes <- read.csv2("C:/MAESTRIA/SEGUNDO_SEMESTRE/VISUALIZACION DE DATOS/PEC2/diagrama_arco/GameofThrones-T1-Network-NODES-CSV.csv")



edges <- read_delim("C:/MAESTRIA/SEGUNDO_SEMESTRE/VISUALIZACION DE DATOS/PEC2/diagrama_arco/GameofThrones-T1-Network-EDGES-CSV.txt", 
                                                 delim = ";", escape_double = FALSE, trim_ws = TRUE)

#nodes <- read_delim("C:/MAESTRIA/SEGUNDO_SEMESTRE/VISUALIZACION DE DATOS/PEC2/diagrama_arco/GameofThrones-T1-Network-NODES-CSV.txt", 
 #                   delim = ";", escape_double = FALSE, trim_ws = TRUE)

nodes <- read_csv("C:/MAESTRIA/SEGUNDO_SEMESTRE/VISUALIZACION DE DATOS/PEC2/diagrama_arco/GameofThrones-T1-Network-NODES-CSV.csv")
...
png("Diagrama_Arco.png", units = "in", width = 10, height = 6, res = 600)
